locals {
    ...
    desired_capacity    = local.common_vars.inputs.desired_capacity_prod
    min_capacity        = local.common_vars.inputs.min_capacity_prod
    max_capacity        = local.common_vars.inputs.max_capacity_prod
}
